...
public class ProductoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponseDTO<ProductoResponseDTO>> getProductoById(@PathVariable @NotBlank String id) throws Exception {
	...
	@Parameters({@Parameter(name = "id", description = "ID del Producto."),})
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponseDTO<ProductoResponseDTO>> updateProducto(@PathVariable @NotBlank String id,   @RequestBody @Valid ProductoRequestDTO req) {
    	log.info("INGRESO A ProductoController.updateProducto(). ID: " +id);
    	return ResponseEntity.status(HttpStatus.OK)
					.body(new ApiResponseDTO<>(true, 
											   MensajeResponseUtil.SUCCESS, 
											   CodeResponseUtil.SUCCESS, 
	...
	@Parameters({@Parameter(name = "id", description = "ID del Producto"),})
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteProducto(@PathVariable @NotBlank String id) {
